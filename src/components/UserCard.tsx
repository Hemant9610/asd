...
export function UserCard({ user, onSendRequest, showRequestButton = true }: UserCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-2 group">
      {/* User Header */}
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {user.skillsWanted.length === 0 && (
            <span className="text-xs text-gray-400 italic">No skills wanted yet</span>
          )}
        </div>
      </div>
      ...
      {showRequestButton && (
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2 group-hover:shadow-md"
